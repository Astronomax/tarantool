...
local default_cfg = {
    ...
    replication_reconnect_timeout = nil, -- replication_timeout by default
...
local template_cfg = {
    ...
    replication_reconnect_timeout = 'number',
...
local function purge_sensitive_data_from_uris(uri)
    ...
    if type(uri) == 'table' then
        uri = purge_sensitive_data_from_uri(uri)
...
local dynamic_cfg_order = {
    ...
    replication_reconnect_timeout = 150,
